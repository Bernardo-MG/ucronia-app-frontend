...
const feeModule = () => import('@app/fees/fees.module').then(m => m.FeesModule);
const transactionModule = () => import('@app/transactions/transactions.module').then(m => m.TransactionsModule);
