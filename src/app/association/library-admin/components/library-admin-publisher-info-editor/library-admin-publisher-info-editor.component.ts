...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, LibraryAdminPublisherFormComponent, LibraryAdminPublisherInfoComponent, ArticleComponent, InfoEditorComponent, EditorHeaderComponent, InfoEditorFormDirective, InfoEditorInfoDirective],
