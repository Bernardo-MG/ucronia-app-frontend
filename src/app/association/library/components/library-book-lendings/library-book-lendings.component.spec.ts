...
describe('LibraryBookLendingsComponent', () => {
  ...
  it('should display the correct number of rows', () => {
    const lendings: BookLending[] = [
      { borrower: { number: 0, name: { firstName: '', lastName: '', fullName: 'John Doe' } }, lendingDate: '2024-01-01', returnDate: '2024-01-05', days: 4 },
      { borrower: { number: 0, name: { firstName: '', lastName: '', fullName: 'Jane Smith' } }, lendingDate: '2024-02-01', returnDate: '2024-02-10', days: 9 },
    ];
