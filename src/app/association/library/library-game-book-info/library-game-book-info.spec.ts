...
import { LibraryGameBookInfo } from './library-game-book-info';

describe('LibraryGameBookInfo', () => {
  let component: LibraryGameBookInfo;
  let fixture: ComponentFixture<LibraryGameBookInfo>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(LibraryGameBookInfo);
