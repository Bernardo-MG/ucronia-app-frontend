...
const routes: Routes = [
  ...
  { path: 'admin/register', component: MemberCreateComponent, canActivate: [ResourceGuard("member", "create")] },
  { path: ':number', component: PublicMemberInfoEditorComponent, canActivate: [ResourceGuard("public_member", "read")] },
  { path: 'admin/:number', component: MemberInfoEditorComponent, canActivate: [ResourceGuard("member", "read")] }
];
