...
import { Contact, Sponsor } from '@ucronia/domain';
...
export class SponsorList {
  ...
  public readonly contacts = input<Sponsor[]>([]);
  public readonly rows = input(0);
  public readonly page = input(0);
  public readonly totalRecords = input(0);

  public readonly show = output<Sponsor>();
  public readonly edit = output<Sponsor>();
