...
export class AccessRoleService {
  ...
  public addPermission(roleId: number, resource: number, action: number): Observable<Permission> {
    return this.roleApi.updatePermission(roleId, resource, action).pipe(map(r => r.content));
  }
