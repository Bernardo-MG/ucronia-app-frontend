...
@Component({
    ...
    imports: [CommonModule, FormsModule, ReactiveFormsModule, FeePayFormComponent, FeeCreationFormComponent, ArticleComponent, FeePaySelectMemberComponent, BackwardIconComponent, CardComponent, CardBodyComponent, BreadcrumbComponent, JustifyBetweenDirective, ResponsiveShortColumnsDirective],
