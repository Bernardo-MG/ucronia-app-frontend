...
@Component({
  selector: 'assoc-library-admin-game-book-lending-member-selection',
  imports: [ButtonListComponent, PaginationNavigationComponent, JustifyCenterDirective, BlockUiDirective],
  templateUrl: './library-admin-game-book-lending-member-selection.component.html'
})
export class LibraryAdminGameBookLendingMemberSelectionComponent {
