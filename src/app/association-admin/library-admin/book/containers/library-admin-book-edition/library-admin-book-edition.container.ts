...
@Component({
    ...
    imports: [CommonModule, RouterModule, FormModule, CardModule, LibraryAdminBookEditionFormComponent, LibraryAdminBookDonorsFormComponent, LibraryAdminBookDetailsComponent, ResponsiveShortColumnsDirective],
