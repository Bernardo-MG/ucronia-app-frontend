...
import { LibraryAdminAuthorCreateComponent } from './author/containers/library-admin-author-create/library-admin-author-create.component';
import { LibraryAdminAuthorInfoEditorComponent } from './author/containers/library-admin-author-info-editor/library-admin-author-info-editor.component';
import { LibraryAdminBookTypeCreateComponent } from './book-type/containers/library-admin-book-type-create/library-admin-book-type-create.component';
...
import { LibraryAdminGameSystemCreateComponent } from './game-system/containers/library-admin-game-system-create/library-admin-game-system-create.component';
import { LibraryAdminGameSystemInfoEditorComponent } from './game-system/containers/library-admin-game-system-info-editor/library-admin-game-system-info-editor.component';
...
import { LibraryAdminPublisherCreateComponent } from './publisher/containers/library-admin-publisher-create/library-admin-publisher-create.component';
import { LibraryAdminPublisherInfoEditorComponent } from './publisher/containers/library-admin-publisher-info-editor/library-admin-publisher-info-editor.component';
