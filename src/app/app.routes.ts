      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () => import('./association/public-members/public-member-list/public-member-list').then(m => m.PublicMemberList)
          },
          {
            path: 'myFees',
          ...
          },
          {
            ...
            loadComponent: () => import('./association/contacts/contact-list/contact-list').then(m => m.ContactList)
          },
          {
            path: 'funds',
