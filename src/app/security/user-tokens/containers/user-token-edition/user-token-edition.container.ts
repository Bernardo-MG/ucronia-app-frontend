...
@Component({
  ...
  imports: [CommonModule, CardModule, FormsModule, ReactiveFormsModule, UserTokenInfoComponent, ModalComponent, UserTokenStatusComponent, WaitingDirective, ResponsiveShortColumnsDirective],
