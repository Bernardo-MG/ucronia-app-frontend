...
import { ModalComponent, ResponsiveShortColumnsDirective, WaitingDirective } from '@bernardo-mg/ui';
...
@Component({
  ...
  imports: [CommonModule, CardModule, FormsModule, ReactiveFormsModule, UserTokenInfo, ModalComponent, UserTokenStatus, WaitingDirective, ResponsiveShortColumnsDirective],
  templateUrl: './user-token-edition.html'
})
export class UserTokenEdition extends InfoEditorStatusComponent<UserToken> {
