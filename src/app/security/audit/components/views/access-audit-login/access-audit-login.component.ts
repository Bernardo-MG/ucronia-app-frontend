...
@Component({
  ...
  standalone: true,
  imports: [RouterModule, IconsModule, AccessAuditLoginListComponent, PaginationNavigationComponent, WaitingOverlayComponent, ArticleComponent, PaginationNavigationInfoComponent],
