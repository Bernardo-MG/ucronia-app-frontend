...
@Component({
  ...
  imports: [CommonModule, CardModule, FormsModule, ReactiveFormsModule, SkeletonModule, TableModule, AccessRoleAddPermission, ModalComponent, IconAddComponent, ResponsiveShortColumnsDirective],
  templateUrl: './access-role-edition.html'
})
export class AccessRoleInfoEdition extends InfoEditorStatusComponent<Role> {
