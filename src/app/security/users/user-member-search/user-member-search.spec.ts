...
import { UserMemberSearch } from './user-member-search';

describe('UserMemberSearch', () => {
  let component: UserMemberSearch;
  let fixture: ComponentFixture<UserMemberSearch>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [UserMemberSearch]
    }).compileComponents();

    fixture = TestBed.createComponent(UserMemberSearch);
