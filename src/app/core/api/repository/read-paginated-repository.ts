...
export class ReadPaginatedRepository<T> {
  ...
  public parameter(name: string, value: any): ReadPaginatedRepository<T> {
  ...
  public sort(sort: Sort<T>[] | undefined): ReadPaginatedRepository<T> {
