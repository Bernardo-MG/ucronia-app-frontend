...
import { WaitingButtonWrapperComponent } from './waiting-button-wrapper.component';

@Component({
  imports: [WaitingButtonWrapperComponent],
  template: `
...
describe('WaitingButtonWrapperComponent', () => {
  ...
  it('should emit action event when button is clicked', () => {
    ...
    const waitingButtonComponent = fixture.debugElement.query(By.directive(WaitingButtonWrapperComponent)).componentInstance;
